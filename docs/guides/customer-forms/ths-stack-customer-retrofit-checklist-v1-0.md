...
- [ ] Cooling method:
  - [ ] Air cooling (HVAC)
  - [ ] Evaporative cooling
  - [ ] Existing liquid cooling (specify): _______
  - [ ] Immersion cooling
  - [ ] Mixed
- [ ] Cooling capacity (tons or kW): _______
- [ ] Age of cooling system: _______ years
- [ ] Seasonal performance issues? [ ] Yes [ ] No
...
- [ ] Primary ASIC models (list all):
  ...
  - Model: _______ Quantity: _______ Age: _______
  - Model: _______ Quantity: _______ Age: _______
- [ ] Total hashboards: _______
- [ ] Total hashrate (PH/s): _______
...
- [ ] PDU configuration:
  - Type: [ ] Basic [ ] Switched [ ] Metered [ ] Smart
  - Quantity: _______
  - Load per PDU: _______A
...
- [ ] Network topology:
  ...
  - [ ] VLANs
  - [ ] Segmented by zone
- [ ] Management switches: _______ (quantity and model)
- [ ] Current monitoring platform: _______
- [ ] Remote access capability? [ ] Yes [ ] No

**Current Performance Metrics**

- [ ] Average efficiency (J/TH): _______
- [ ] Average uptime (%): _______
- [ ] Planned downtime per month (hours): _______
- [ ] Unplanned downtime per month (hours): _______
...
- [ ] Annual maintenance costs ($): _______
...
- [ ] Available space for new cooling equipment? [ ] Yes [ ] No [ ] Unknown
...
- [ ] Minimum uptime requirement during retrofit (%): _______
...
- [ ] Financing options of interest:
  - [ ] Upfront payment
  - [ ] Equipment financing (24-48 months)
  - [ ] Revenue share model
  - [ ] Other: _______
- [ ] Expected payback period requirement: _______ months
...
- [ ] Photos/videos of facility (interior & exterior)
- [ ] Existing cooling system specifications
- [ ] Historical performance data (uptime, efficiency, revenue)
- [ ] Electrical utility bills (last 3-6 months)
...
4. **On-site Survey (if needed):** 2-3 day site visit for complex facilities
5. **Final Proposal (14-18 business days):** Complete retrofit design, BOM, pricing, timeline

---

## Performance Guarantee

All TerraHash Stack retrofits include:
✅ **Minimum 20% J/TH efficiency improvement** (or warranty service)
✅ **99%+ uptime target** within 90 days of completion
✅ **Fixed-price contracts** with defined scope and milestones
✅ **Tiered SLA options** (Platinum 99.5%, Gold 99%, Silver 98%)
...
**Questions?**
Schedule a 30-minute consultation: [calendly-link]
...
- **Expected Outcome:** Variable based on strategy chosen
