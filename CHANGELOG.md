...
All notable changes to the Ryno Crypto Services and TerraHash Stack documentation repository will be documented in this file.
...
- PRD structure moved from /docs/prd to /prd/active
- Media assets reorganized from /media to /assets
...
- Corrected .pre-commit-config.yaml naming
...
- Bitcoin art collection
- TerraHash Stack infographics
- Wharton facility documentation
...
|---------|------------|-------------|
| 2.0.0   | 2025-11-07 | Repository reorganization and standards compliance |
| 1.0.0   | 2025-10-22 | Initial repository with core documentation |
...
**Note:** This changelog is automatically updated as part of our contribution workflow. See CONTRIBUTING.md for details on how changes are documented.
